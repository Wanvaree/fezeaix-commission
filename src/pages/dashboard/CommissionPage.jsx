    ...
    return (
        <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
                สามารถดูเรทราคาคอมมิชชั่นของเราได้เลยนะคะ 💕 มีตัวอย่างงานเพิ่มเติม สามารถขอตัวอย่างเพิ่มเติมได้เสมอเลยค่ะ!  และด้านล่างจะมีเงื่อนไขการสั่งงานหรือข้อตกลงต่างๆ รวบกวนอ่านก่อนสั่งนะคะ 💌✨
            </p>
